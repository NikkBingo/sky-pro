...
function directSizeExtract() {
    console.log('🔍 Direct size chart extraction...\n');
    ...
    // Product 10360 size chart (lines 87-174)
    console.log('📋 Extracting 10360 size chart...');
    const sizeChart10360 = extractSizeChartFromRange(lines, 87, 174);
    sizeCharts['10360'] = sizeChart10360;
    
    // Product 10380 size chart (lines 175-256)
    console.log('📋 Extracting 10380 size chart...');
    const sizeChart10380 = extractSizeChartFromRange(lines, 175, 256);
    sizeCharts['10380'] = sizeChart10380;
    
    // Product 10440 size chart (lines 257-338)
    console.log('📋 Extracting 10440 size chart...');
    const sizeChart10440 = extractSizeChartFromRange(lines, 257, 338);
...
function extractSizeChartFromRange(lines, startLine, endLine) {
