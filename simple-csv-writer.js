...
function simpleCSVWriter() {
    console.log('🔍 Simple CSV writer with proper formatting...\n');
...
function writeSimpleCSV(lines) {
    console.log('📝 Writing CSV with simple formatting...');
    
    // Use a simple approach: write line by line
    const outputStream = fs.createWriteStream('KH-print_skypro_translated_final.csv', {
        encoding: 'utf8',
        flags: 'w'
    });
    ...
    outputStream.on('finish', () => {
        console.log('✅ CSV written with simple formatting.');
        
        // Verify the file was written correctly
        const stats = fs.statSync('KH-print_skypro_translated_final.csv');
        console.log(`📊 File size: ${stats.size} bytes`);
        
        // Check a sample of the output
        const sampleContent = fs.readFileSync('KH-print_skypro_translated_final.csv', 'utf8');
