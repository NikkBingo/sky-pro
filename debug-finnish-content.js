...
if (product877) {
    console.log('Product 877 Finnish content:');
    console.log('Title:', product877.title);
    console.log('Description length:', product877.description ? product877.description.length : 'undefined');
    console.log('Description preview:', product877.description ? product877.description.substring(0, 100) + '...' : 'undefined');
} else {
    console.log('Product 877 not found');
}

console.log('Total Finnish products loaded:', finnishTranslationsMap.size); 