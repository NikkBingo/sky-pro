...
function properCSVParsing() {
    console.log('🔍 Using proper CSV parsing library...\n');
    
    const results = [];
    
    // Parse the Finnish translations file using csv-parser
        ...
        fs.createReadStream('finnish-translations.csv')
            ...
            .on('end', () => {
                ...
                if (bodyHtml10360) {
                    ...
                    console.log(`📏 First 200 chars: ${bodyHtml10360['Translated content'].substring(0, 200)}`);
                    console.log(`📏 Last 200 chars: ${bodyHtml10360['Translated content'].substring(bodyHtml10360['Translated content'].length - 200)}`);
...
properCSVParsing().catch(console.error); 